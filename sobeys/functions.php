...
function course_registration_form(){
    ...
    $return .= '<div class="row">';
        $return .= '<div class="col-4">';
            ...
            $return .= '<strong>Maximun Qty: </strong>'.$productVariation->max.'</p>';
        $return .= '</div>';
            ...
            $return .= '
                <div>
                    <form method="post" action="">
                        ...
                        <div>
                            <label>Number Of Participants (Max: '.$productVariation->max.')</label>
...
class VariationInformationRegistration{
    ...
    public function submitForm($post){
        ...
        $message .= '<strong>Location: </strong>'.$post['registrant_phone_number'].'<br/>';
